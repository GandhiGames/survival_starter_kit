...
/// </summary>
	...
	public class DamageAnimationController : MonoBehaviour
	{
		...
		public float ChainLightningDelay = 0.2f;
		...
		public void ApplySpecialDamage (SPECIAL_DAMAGE_TYPE damageType, float dps, float time)
		{
		...
		private void ApplyLightningChain (float dps, float time)
		{
			...
			gameObject.AddComponent<ElectricHit> ();	
